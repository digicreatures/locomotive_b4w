...
function(a){a.currentTarget.style.visibility="hidden"})}function n(){b.data.load(p+"locomotive.json",function(){b.app.enable_camera_controls();l();m()})}var b={app:a("app"),config:a("config"),version:a("version"),data:a("data"),objects:a("objects"),ctrl:a("controls"),scenes:a("scenes"),anchors:a("anchors"),container:a("container")},f="DEBUG"==b.version.type(),p=b.config.get_assets_path("locomotive_b4w");g.init=function(){b.app.init({canvas_container_id:"locomotive_viewer",show_fps:f,console_verbose:f,
force_container_ratio:16/9,report_init_failure:!0,autoresize:!0,callback:function(a,b){b?n():console.log("Application cannot started")}})}});b4w.require("locomotive").init();
